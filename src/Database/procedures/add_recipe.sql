...
AS $$
BEGIN
    INSERT INTO recipe_ingredients (recipe_id, ingredient_id, unit_id, quantity_left, quantity_right, required)
    VALUES (recipe_id, ingredient_id, unit_id, quantity_left, quantity_right, required);
END;
$$;